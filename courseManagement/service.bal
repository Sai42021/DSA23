...
isolated service /courses on new http:Listener(8080) {
    ...
    isolated resource function post create(@http:Payload CourseDetail new_course) returns json {
    ...
    isolated resource function get course(int code) returns CourseDetail? {
